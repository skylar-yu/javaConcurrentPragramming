...
public class TestCache {
    private static final Computable<Integer,String> computable = new ResolvePrime();
    private static final Memoizer<Integer, String> memoizer = new Memoizer<>(computable);
